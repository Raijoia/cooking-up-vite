...
export default {
  ...
  methods: {
    ...
    removerIngrediente(ingredienteRemovido: string) {
      this.ingredientes = this.ingredientes.filter(ingrediente => ingrediente !== ingredienteRemovido)
    },
    mudarConteudo(conteudo: Pagina) {
